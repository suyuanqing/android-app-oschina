...
public class MineFnsActivity extends BaseActivity {
    ...
    protected void loadData() {
        ...
        iLoadMine.getFnsList(uid, 0 + "", Arguments.MINE_FNS, new NetworkCallback() {
            @Override
            public void onSuccess(String result) {
//                LogUtils.e("MineFnsActivity", result);
