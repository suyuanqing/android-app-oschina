...
public class SendBlogComment {
    ...
    private SendBlogComment(){

    }

    private static SendBlogComment sendComment;
    public static SendBlogComment getInstance(){

        if (sendComment == null){
            synchronized (SendBlogComment.class){
                if (sendComment == null)
                    sendComment = new SendBlogComment();
            }
        }
        return sendComment;
    }

    public void popupView(final Context context, final String id, final String uid) {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                iLoadComment.pubBlogComment(id, uid, content, new NetworkCallback() {
                    @Override
